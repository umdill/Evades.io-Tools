...
4. Open the userscript:

   * https://github.com/umdill/Evades.io-TAS/raw/refs/heads/main/tas.user.js
5. Click **Install** when Tampermonkey prompts you.
...
1. Install **Tampermonkey** from the Microsoft Edge Add-ons Store:
...
1. Install **Tampermonkey** from Mozilla Add-ons:

   * https://addons.mozilla.org/firefox/addon/tampermonkey/
2. No additional configuration is required.
3. Open the userscript:

   * https://github.com/umdill/Evades.io-TAS/raw/refs/heads/main/tas.user.js
4. Click **Install** when Tampermonkey prompts you.
...
1. Install **Tampermonkey** from the Chrome Web Store:
   ...
   * https://chromewebstore.google.com/detail/tampermonkey/dhdgffkkebhmkfjojejmpbldmpobfkfo
2. If prompted, enable support for Chrome extensions.
3. Open:

   ```
   opera://extensions/?id=dhdgffkkebhmkfjojejmpbldmpobfkfo
   ```
4. Enable **Allow User Scripts**.
5. Open the userscript:

   * https://github.com/umdill/Evades.io-TAS/raw/refs/heads/main/tas.user.js
6. Click **Install** when Tampermonkey prompts you.
